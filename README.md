...
| Right Stick Right   | Axis 4 Increase | t          |            |
| Right Stick Left    | Axis 4 Decrease | g          |            |
| Right Stick Up      | Axis 5 Increase | h          |            |
| Right Stick Down    | Axis 5 Decrease | f          |            |
| A                   | Button 1        | z          |            |
| B                   | Button 2        | x          |            |
| X                   | Button 3        | c          |            |
| Y                   | Button 4        | v          |            |
...
| LT                  | Button 11       | e          |            |
| RT                  | Button 12       | y          |            |
| Left Trigger Up     | Axis 2 Increase |            |            |
| Left Trigger Down   | Axis 2 Decrease |            |            |
| Right Trigger Up    | Axis 3 Decrease |            |            |
| Right Trigger Down  | Axis 3 Decrease |            |            |
